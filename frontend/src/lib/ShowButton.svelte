<script lang="ts">
  ...
  export function setup() {
    app.ui.settings.addSetting({
      ...
      onChange(value: string) { location = value; },
    });
    ...
    app.ui.settings.addSetting({
      ...
      onChange(value: number) { xMargin = value; },
    });
    ...
    app.ui.settings.addSetting({
      ...
      onChange(value: number) { yMargin = value; },
    });
  }
</script>

<button
  class="{Constants.CSS_CLASS_BUTTON} {Constants.CSS_CLASS_SHOW_BUTTON}"
